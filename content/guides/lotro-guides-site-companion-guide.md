...
excerpt: "Discover everything LOTRO Guides has to offer — from searchable databases with 38,000+ items to an interactive map of Middle-earth, raid loot tables, and in-depth strategy guides."
---
...
The heart of the site is a collection of databases pulled from in-game data. Every database supports instant search, column sorting, and multi-filter combinations so you can find exactly what you need.

### Items Database — 38,000+ Items
...
The [Instances Database](/instances) covers every group instance in the game. The listing page shows group size, tier count, mob count, and whether loot data is available.
...
The [Virtues Database](/virtues) shows every virtue with stats per tier, max rank, and the mitigation and mastery bonuses each rank provides. Useful when planning virtue slotting for your build.
...
The [Media](/media) page collects official LOTRO videos in an embedded gallery. Watch trailers, developer updates, and event recaps without leaving the site.
...
2. **Use the instance loot tables before raids** — check what drops from each boss so you know which tier to run and what to roll on
3. **Cross-reference sets and items** — find a set bonus you want in the Sets Database, then look up individual pieces in the Items Database to see where they drop
4. **Filter deeds by reward** — if you're farming LOTRO Points, filter the Deeds Database by LP reward to find the most efficient grind
5. **Check the Raid Preparation Guide** — before any endgame content, use the stat target tables and consumable checklists to make sure your character is ready
6. **Share map views** — use the share button on the map to send a kinship member the exact location of a hard-to-find quest objective

---

## Community

Every guide and instance page has a **comments section** where you can share tips, ask questions, or report outdated information. You can also support the site via the **Buy Me a Coffee** button on the homepage.

LOTRO Guides is a community project — if you spot missing data or have a suggestion, drop a comment on the relevant page.

---

*Welcome to Middle-earth. May your road go ever on.*
